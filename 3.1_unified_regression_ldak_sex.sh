...
./ldak6.linux --linear ${section_03_dir}/model001_trio_nopc_${gwasoutcome} --pheno ${section_03_dir}/temp.${gwasoutcome}.pheno --bfile ${bfile_raw} --covar ${temp_covariate_nopcs_file} --families YES --keep ${trio_ids} --max-threads 8 > ${section_03_dir}/logs/model001_trio_nopc_${gwasoutcome}.log
...
./ldak6.linux --linear ${section_03_dir}/model01_trio_pop_${gwasoutcome} --pheno ${section_03_dir}/temp.${gwasoutcome}.pheno --bfile ${bfile_raw} --covar ${temp_covariate_file} --families YES --keep ${trio_ids} --max-threads 8 > ${section_03_dir}/logs/model01_trio_${gwasoutcome}.log
...
rm -f ${section_03_dir}/temp.${gwasoutcome}.*
rm -f ${section_03_dir}/*.progress
rm -f ${section_03_dir}/*.pvalues
rm -f ${section_03_dir}/*.score
